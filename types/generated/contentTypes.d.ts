...
export interface ApiCoachCoach extends Schema.CollectionType {
  ...
  attributes: {
    ...
    experience: Attribute.Integer & Attribute.DefaultTo<1>;
    players: Attribute.Relation<
      'api::coach.coach',
      'oneToMany',
      'api::psl-player.psl-player'
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiOrderOrder extends Schema.CollectionType {
  ...
  attributes: {
    ...
    paymentProvider: Attribute.JSON & Attribute.Required;
...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    Category: Attribute.Enumeration<
      ['pen', 'pencil', 'eraser', 'marker', 'pointer']
    > &
      Attribute.Required &
      Attribute.DefaultTo<'pen'>;
    size: Attribute.String &
      Attribute.SetMinMaxLength<{
        maxLength: 60;
      }>;
    color: Attribute.Enumeration<
      ['white', 'blue', 'green', 'red', 'yellow', 'pink', 'orange']
    > &
      Attribute.Required &
...
export interface ApiPslPlayerPslPlayer extends Schema.CollectionType {
  ...
  attributes: {
    ...
    > &
      Attribute.Required &
      Attribute.DefaultTo<'AllRounder'>;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::psl-player.psl-player': ApiPslPlayerPslPlayer;
    }
  }
}
